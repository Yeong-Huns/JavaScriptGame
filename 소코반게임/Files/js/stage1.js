...
let classList = ["NONE","BLOCK","ROAD","CHEESE","HOUSE","FULL", "PLAYER"];
...
function gameClear(){
    ...
    if(conf == false) location.href = "../stage/stage1.html";
    else location.href = "../stage/stage2.html";
}
